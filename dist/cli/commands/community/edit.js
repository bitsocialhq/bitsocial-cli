...
export default class Edit extends BaseCommand {
    static description = "Edit a community's properties. For a list of properties, visit https://github.com/plebbit/plebbit-js#subplebbiteditsubplebbiteditoptions";
    static args = {
        address: Args.string({
            name: "address",
            required: true,
